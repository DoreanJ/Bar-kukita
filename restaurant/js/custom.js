...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-BAR.png");
			jQuery(".footer-logo .text-center img").attr("src", "LOGO-BAR.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/LOGO-BAR.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/LOGO-BAR.png");
			return false;
		});
